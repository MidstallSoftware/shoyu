...
#define SHOYU_OUTPUT(object) (G_TYPE_CHECK_INSTANCE_CAST((object), SHOYU_TYPE_OUTPUT, ShoyuOutput))
#define SHOYU_OUTPUT_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), SHOYU_TYPE_OUTPUT, ShoyuOutputClass))
#define SHOYU_IS_OUTPUT(object) (G_TYPE_CHECK_INSTANCE_TYPE((object), SHOYU_TYPE_OUTPUT))
#define SHOYU_IS_OUTPUT_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), SHOYU_TYPE_OUTPUT))
#define SHOYU_OUTPUT_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), SHOYU_TYPE_OUTPUT, ShoyuOutputClass))
