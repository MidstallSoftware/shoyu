...
#define SHOYU_COMPOSITOR(object)                                               \
  (G_TYPE_CHECK_INSTANCE_CAST((object), SHOYU_TYPE_COMPOSITOR, ShoyuCompositor))
#define SHOYU_COMPOSITOR_CLASS(klass)                                          \
  (G_TYPE_CHECK_CLASS_CAST((klass), SHOYU_TYPE_COMPOSITOR,                     \
                           ShoyuCompositorClass))
#define SHOYU_IS_COMPOSITOR(object)                                            \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), SHOYU_TYPE_COMPOSITOR))
#define SHOYU_IS_COMPOSITOR_CLASS(klass)                                       \
  (G_TYPE_CHECK_CLASS_TYPE((klass), SHOYU_TYPE_COMPOSITOR))
#define SHOYU_COMPOSITOR_GET_CLASS(obj)                                        \
  (G_TYPE_INSTANCE_GET_CLASS((obj), SHOYU_TYPE_COMPOSITOR,                     \
                             ShoyuCompositorClass))
