...
#define SHOYU_INPUT(object)                                                    \
  (G_TYPE_CHECK_INSTANCE_CAST((object), SHOYU_TYPE_INPUT, ShoyuInput))
#define SHOYU_INPUT_CLASS(klass)                                               \
  (G_TYPE_CHECK_CLASS_CAST((klass), SHOYU_TYPE_INPUT, ShoyuInputClass))
#define SHOYU_IS_INPUT(object)                                                 \
  (G_TYPE_CHECK_INSTANCE_TYPE((object), SHOYU_TYPE_INPUT))
#define SHOYU_IS_INPUT_CLASS(klass)                                            \
  (G_TYPE_CHECK_CLASS_TYPE((klass), SHOYU_TYPE_INPUT))
#define SHOYU_INPUT_GET_CLASS(obj)                                             \
  (G_TYPE_INSTANCE_GET_CLASS((obj), SHOYU_TYPE_INPUT, ShoyuInputClass))
