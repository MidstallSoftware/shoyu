...
#define SHOYU_XDG_TOPLEVEL(object) (G_TYPE_CHECK_INSTANCE_CAST((object), SHOYU_TYPE_XDG_TOPLEVEL, ShoyuXdgToplevel))
#define SHOYU_XDG_TOPLEVEL_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), SHOYU_TYPE_XDG_TOPLEVEL, ShoyuXdgToplevelClass))
#define SHOYU_IS_XDG_TOPLEVEL(object) (G_TYPE_CHECK_INSTANCE_TYPE((object), SHOYU_TYPE_XDG_TOPLEVEL))
#define SHOYU_IS_XDG_TOPLEVEL_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), SHOYU_TYPE_XDG_TOPLEVEL))
#define SHOYU_XDG_TOPLEVEL_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), SHOYU_TYPE_XDG_TOPLEVEL, ShoyuXdgToplevelClass))
