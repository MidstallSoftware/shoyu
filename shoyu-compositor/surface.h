...
#define SHOYU_SURFACE(object) (G_TYPE_CHECK_INSTANCE_CAST((object), SHOYU_TYPE_SURFACE, ShoyuSurface))
#define SHOYU_SURFACE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST((klass), SHOYU_TYPE_SURFACE, ShoyuSurfaceClass))
#define SHOYU_IS_SURFACE(object) (G_TYPE_CHECK_INSTANCE_TYPE((object), SHOYU_TYPE_SURFACE))
#define SHOYU_IS_SURFACE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), SHOYU_TYPE_SURFACE))
#define SHOYU_SURFACE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj), SHOYU_TYPE_SURFACE, ShoyuSurfaceClass))
