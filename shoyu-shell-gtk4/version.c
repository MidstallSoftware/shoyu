 ...
 *
 * Returns: the binary age of the Shoyu Shell GTK 4 library
 */
 ...
 * If `libtool` means nothing to you, don't worry about it.
 *
 * Returns: the interface age of the Shoyu Shell GTK 4 library
 */
 ...
 *
 * Checks that the Shoyu Shell GTK 4 library in use is compatible with the
 * given version.
 *
 ...
 */
const char *shoyu_shell_gtk_check_version(guint required_major,
                                          guint required_minor,
                                          guint required_micro) {
  int shoyu_shell_gtk_effective_micro =
      100 * SHOYU_SHELL_GTK_MINOR_VERSION + SHOYU_SHELL_GTK_MICRO_VERSION;
  ...
  if (required_effective_micro <
      shoyu_shell_gtk_effective_micro - SHOYU_SHELL_GTK_BINARY_AGE)
